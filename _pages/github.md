...
<img src="https://github-profile-trophy.vercel.app?username=MUmarShahbaz&row=3&column=3&margin-w=8&margin-h=8&no-bg=false&no-frame=false&order=4" class="no-shadow" loading="lazy" alt="GitHub Trophies" style="max-width: 350px; width: -webkit-fill-available">
</div>
<br>
<img src="https://github-readme-activity-graph.vercel.app/graph?username=MUmarShahbaz&radius=16&area=true&order=5&theme=github-light" class="no-shadow black-border rounded-corners" loading="lazy" alt="Commits in last 30 days" style="max-width: 1000px; width: -webkit-fill-available">
<br class="spacer">